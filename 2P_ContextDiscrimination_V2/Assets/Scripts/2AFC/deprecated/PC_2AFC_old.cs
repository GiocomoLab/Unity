...
public class PC_2AFC_old : MonoBehaviour
{
    ...
    {   // lickports
        ...
        arduino.pinMode(9, PinMode.OUTPUT); // L - water or .5 mM diluted quinine
    ...
    { // deliver
        // 3/20/18 change trials so its a 80% chance you see the same one again
        // if you get it wrong, 50% if you get it right
        if (r == 1) // reward left
        {
            prevReward = 1;
