...
public class SlideTableCOM_FlashLED : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        pc = player.GetComponent<PC_FlashLED_2Port>();
    ...
    void Update()
    {
        ...
        if (pc.cmd == 1 | pc.cmd == 2 | pc.cmd == 7 | pc.cmd == 9 | pc.cmd == 8 | pc.cmd == 4)
        {
