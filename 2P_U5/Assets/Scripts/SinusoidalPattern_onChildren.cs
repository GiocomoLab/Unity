...
public class SinusoidalPattern_onChildren : MonoBehaviour {
    ...
    void Start () {
        ...
        //playerScript = player.GetComponent<TrainingTrack.PlayerController>();
        numTraversals = player.GetComponent<PlayerController>().numTraversals;
	...
	void Update () {
        ...
        if (numTraversals > numTraversals_local)
        {
            //numTraversals_local = playerScript.numTraversals;
            numTraversals_local = numTraversals;
            //StartCoroutine(drawSineWall());
        }
