...
public class ReadRotary_NH : MonoBehaviour {
	...
	private PC_NeuHall playerScript;
    ...
    void Start()
	{
		...
		playerScript = player.GetComponent<PC_NeuHall> ();
	...
	void Update() 
	{
        if (playerScript.pcntrl_pins & !recordingStarted_local)
        {
