...
public class FixCrossController : MonoBehaviour {
    ...
    void Start()
    {
        ...
        rewardFile = localDirectory + "/" + paramsScript.mouse + "/" + paramsScript.session + "_MRewards.txt";
        serverRewardFile = serverDirectory + "/" + paramsScript.mouse + "/" + paramsScript.session + "_MRewards.txt";
    ...
    IEnumerator FlashCross()
    {
        while (true)
        {
            ...
            float timeout = 30f * UnityEngine.Random.value + 10.0f;
            cmd = 3;
