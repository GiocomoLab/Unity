...
public class DetectLicks_2Port_Flash_LED_Cue : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        pc = player.GetComponent<PC_Flash_LED_Cue>();
        if (paramsScript.saveData)
        {
            string lickFile_pre = paramsScript.localDirectory + "/" + paramsScript.session + "_LED_licks.txt";
            string serverLickFile_pre = paramsScript.serverDirectory + "/" + paramsScript.session + "_LED_licks.txt";
