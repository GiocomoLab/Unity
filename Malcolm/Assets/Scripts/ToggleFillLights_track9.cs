...
public class ToggleFillLights_track9 : MonoBehaviour {
	...
	private PlayerController_track9 playerScript;

	void Start () {
		GameObject player = GameObject.Find ("Player");
		playerScript = player.GetComponent<PlayerController_track9> ();
	}
